...
SELECT
	...
	, (CASE WHEN Z.TIPO_MOVIMIENTO_MES like 'TRANSFER_IN' THEN
		nvl(datediff(C.FECHA, A_MES_ANT.FECHA_ALTA), datediff(C.FECHA, TO_MES_ANT.FECHA_TRANSFERENCIA))
	...
	, (CASE WHEN upper(Z.LINEA_NEGOCIO_Homologado) like 'POSPAGO' THEN 
		nvl(A_MES_ANT.FECHA_ALTA, TO_MES_ANT.FECHA_TRANSFERENCIA) END) AS FECHA_ALTA_PREPAGO
	--------------FIN REFACTORING-----------------
	-----_______/\/\/\/\/\/\/\/\/\/\/\_____----
